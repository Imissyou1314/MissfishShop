...
public class ReflashListViewTwo extends ListView implements OnScrollListener {
	...
	public ReflashListViewTwo(Context context) {
		super(context);
	}

	public ReflashListViewTwo(Context context, AttributeSet attrs) {
		super(context, attrs);
		initHeaderView();
		initFooterView();
